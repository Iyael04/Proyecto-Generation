	...
	switch (e.target.name) {
		...
		case "category":
			if(expresiones.category.test(e.target.value)){
				document.getElementById('grupo__category').classList.remove('formulario__grupo-incorrecto');
				document.getElementById('grupo__category').classList.add('formulario__grupo-correcto');
				document.querySelector('#grupo__category i').classList.add('fa-check-circle');
				document.querySelector('#grupo__category i').classList.remove('fa-times-circle');
				document.querySelector('#grupo__category .formulario__input-error').classList.remove('formulario__input-error-activo');

			}else{
				document.getElementById('grupo__category').classList.add('formulario__grupo-incorrecto');
				document.getElementById('grupo__category').classList.remove('formulario__grupo-correcto');
				document.querySelector('#grupo__category i').classList.add('fa-times-circle');
				document.querySelector('#grupo__category i').classList.remove('fa-check-circle');
				document.querySelector('#grupo__category .formulario__input-error').classList.add('formulario__input-error-activo');
			}
		break;
