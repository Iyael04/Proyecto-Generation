...
const validarFormulario = (e) => {
  switch (e.target.name) {
    ...
    case "apellido":
      if (expresiones.nombre.test(e.target.value)) {
        document
          .getElementById("grupo__apellido")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__apellido")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__apellido i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__apellido i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__apellido .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__apellido")
    ...
    case "nombre-comercio":
      if (expresiones.nombrecomercio.test(e.target.value)) {
        document
          .getElementById("grupo__nombre-comercio")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__nombre-comercio")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__nombre-comercio i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__nombre-comercio i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__nombre-comercio .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__nombre-comercio")
    ...
    case "titular":
      if (expresiones.nombre.test(e.target.value)) {
        document
          .getElementById("grupo__titular")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__titular")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__titular i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__titular i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__titular .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__titular")
    ...
    case "nombre-usuario":
      if (expresiones.nombrecomercio.test(e.target.value)) {
        document
          .getElementById("grupo__nombre-usuario")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__nombre-usuario")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__nombre-usuario i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__nombre-usuario i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__nombre-usuario .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__nombre-usuario")
    ...
    case "apellidos-usuario":
      if (expresiones.nombrecomercio.test(e.target.value)) {
        document
          .getElementById("grupo__apellidos-usuario")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__apellidos-usuario")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__apellidos-usuario i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__apellidos-usuario i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__apellidos-usuario .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__apellidos-usuario")
    ...
    case "password-usuario":
      if (expresiones.password.test(e.target.value)) {
        document
          .getElementById("grupo__password-usuario")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__password-usuario")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__password-usuario i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__password-usuario i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__password-usuario .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__password-usuario")
    ...
    case "localizacion":
      if (expresiones.localizacion.test(e.target.value)) {
        document
          .getElementById("grupo__localizacion")
          .classList.remove("formulario__grupo-incorrecto");
        document
          .getElementById("grupo__localizacion")
          .classList.add("formulario__grupo-correcto");
        document
          .querySelector("#grupo__localizacion i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#grupo__localizacion i")
          .classList.remove("fa-times-circle");
        document
          .querySelector("#grupo__localizacion .formulario__input-error")
          .classList.remove("formulario__input-error-activo");
      } else {
        document
          .getElementById("grupo__localizacion")
...
formulario.addEventListener("submit", (e) => {
  ...
  postData(url, newseller).then((data) => {
    alerta();
    function alerta() {
